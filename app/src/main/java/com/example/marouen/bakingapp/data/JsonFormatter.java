package com.example.marouen.bakingapp.data;
...
import com.example.marouen.bakingapp.model.Step;
...
public final class JsonFormatter {
    ...
    private static final String MY_JSON = "theJson";
    ...
    public static List<Recipe> fetchRecipeData(String requestURL, SharedPreferences preferences){
        ...
        mPreferences.edit().putString(MY_JSON, jsonResponse).apply();
    ...
    private static ArrayList<Recipe> extractDataFromJson() {
        String json = mPreferences.getString(MY_JSON,"");
        int id;
        String name;
        int servings;
        String imageUrl;
